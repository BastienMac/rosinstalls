...
JNIEXPORT jstring JNICALL
Java_com_example_bastien_tangodatahandler_TangoJNINative_getEventString(
    JNIEnv* env, jobject) {
...
JNIEXPORT jint JNICALL
Java_com_example_bastien_tangodatahandler_TangoJNINative_connectOnFrameAvailableCallbackB(
JNIEnv*, jobject)
{
    return static_cast<int>(app.ConnectYUVFrameCallbackB());
}

JNIEXPORT jint JNICALL
Java_com_example_bastien_tangodatahandler_TangoJNINative_setupConfigB(
    JNIEnv*, jobject) {
  return app.SetupConfigB();
}
