...
#include <mutex> //added by Bastien
#include <string> //added by Bastien
...
class PointCloudData {
 public:
  ...
  /*
  -----------------------------------------------------------------------------------------
  public part added by Bastien
  -----------------------------------------------------------------------------------------
  */

  // Compose the point cloud debug string.
  //
  // @return: point cloud debug strings for dispaly on Java activity.
  std::string GetPointCloudDebugString();
 ...
 private:
  ...
  /*
  -----------------------------------------------------------------------------------------------
  private part added by Bastien
  -----------------------------------------------------------------------------------------------
  */

  // Debug cloud point string.
  std::string point_cloud_string_;

  // Format the cloud point debug string.
  void FormatPointCloudString();
